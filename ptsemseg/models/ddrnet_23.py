...
class DDRNET_23(nn.Module):
    def __init__(self, block=BasicBlock, layers=[2, 2, 2, 2], num_classes=19, planes=64, spp_planes=128, head_planes=128, augment=True):
        super(DDRNET_23, self).__init__()
