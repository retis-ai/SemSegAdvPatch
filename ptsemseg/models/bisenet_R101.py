...
from ptsemseg.models.utils_for_bisenet.resnet import resnet101
from ptsemseg.models.utils_for_bisenet.seg_oprs import ConvBnRelu, AttentionRefinement, FeatureFusion




class BISENET_R101(nn.Module):
    def __init__(self, num_classes=19, is_training=None,
                 criterion=None, pretrained_model=None,
                 norm_layer=nn.BatchNorm2d):
        super(BISENET_R101, self).__init__()
